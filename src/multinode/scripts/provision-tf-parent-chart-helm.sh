...
export CONTRAIL_CONTROLLER_NODE_01=k8s-node-1
export CONTRAIL_CONTROLLER_NODE_02=k8s-node-2
export CONTRAIL_CONTROLLER_NODE_03=k8s-node-3

export CONTRAIL_COMPUTE_KERNEL_01=k8s-node-1
export CONTRAIL_COMPUTE_KERNEL_02=k8s-node-2
export CONTRAIL_COMPUTE_KERNEL_03=k8s-node-3

#export CONTRAIL_COMPUTE_DPDK_01=k8s-node03
#export CONTRAIL_COMPUTE_DPDK_02=k8s-node04

##### Controller IP Addresses MGMT Network ###########
export CONTROLLER_NODE=10.0.20.2,10.0.20.3,10.0.20.4

export CONTROL_DATA_NET_LIST=10.0.20.0/24
export VROUTER_GATEWAY=10.0.20.1
...
cd ${OSH_PATH}
./tools/deployment/common/wait-for-pods.sh contrail 1200
